...
public class ApiClient {
    ...
    private UnbxdResponse executeRequest(HttpMethod requestType, String baseUrl, Map<String,String> cookies, Map<String,String> headers, Map<String,Object> queryParams,
    ...
    public UnbxdResponse executeRequest(HttpMethod requestType,UnbxdRequestSpecification requestSpecification){
