...
public class WebsiteGroup2Test extends BaseTest {
    ...
    @FileToTest(value = "/frontEndTestData/suggestionVerificationGroup2Urls.json")
    ...
    public void verifySuggestionsTest(String url, String query) {
        ...
        siteActions.searchQuery(query, siteActions.group2searchBox);
    ...
    @FileToTest(value = "/frontEndTestData/websiteGroup2Urls.json")
