...
import core.ui.frontendui.actions.Pagination_SiteActions;
...
public class Pagination_SiteTest extends BaseTest {
    @Page
    Pagination_SiteActions Pagination_SiteActions;
    @Page
    ...
    @Test(description = "Pagination verification ", dataProvider = "getUrl")
    public void Pagination(String url, String query) throws Exception {

        search_SiteActions.goToWebsite(url);
        maximizeWindow();
        search_SiteActions.search_Query(query, search_SiteActions.searchBox);
        await();
        Pagination_SiteActions.verify_pagination1(url);
      //  Pagination_SiteActions.verify_pagination_PreviousNext();
    }
