...
public class Search_SiteTest extends BaseTest {
    @Page
    ...
    @Test(description = "Search verification ", dataProvider = "getUrl")
    public void search(String url, String query) throws Exception {
